...
contract Simargl is Context, IERC20, Ownable {
    ...
    string private _name = "Simargl Token";
    string private _symbol = "SIMA";
    ...
    uint256 private numTokensSellToAddToLiquidity = 10 ** 14 * 10**9;
